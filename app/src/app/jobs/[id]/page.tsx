      ...
      <main className="max-w-lg mx-auto pb-40">
        ...
        {images.length > 0 && (
          <div className="px-5 mt-8">
             <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl shadow-purple-900/10 bg-white p-2">
                <div className="relative w-full h-full rounded-[32px] overflow-hidden">
                   <Image src={images[0].url} alt="Poster Loker" fill className="object-cover" />
                </div>
             </div>
          </div>
        )}
